...
const data: IndustryPageData = {
  ...
  faqs: [
    ...
    { question: "How much do event venues lose from missed calls?", answer: "$300,000 or more per year. Couples and corporate planners tour multiple venues — the first to respond and schedule a tour wins the booking." },
