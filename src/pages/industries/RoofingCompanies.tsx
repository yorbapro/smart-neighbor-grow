...
const data: IndustryPageData = {
  ...
  faqs: [
    ...
    { question: "How much do roofing companies lose from missed calls?", answer: "$250,000 or more per year. After major storms, call volume can spike 10x — and every missed call goes straight to a competitor." },
