...
const data: IndustryPageData = {
  ...
  faqs: [
    ...
    { question: "How much do private investigators lose from missed calls?", answer: "$85,000 or more per year. PI clients often call during moments of urgency and distress — if they reach voicemail, they immediately contact another investigator." },
