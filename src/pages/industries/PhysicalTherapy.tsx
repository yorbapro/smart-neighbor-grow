...
const data: IndustryPageData = {
  ...
  faqs: [
    ...
    { question: "How much do physical therapy centers lose from missed calls?", answer: "$95,000 or more per year. Post-surgical patients have narrow recovery windows — if they can't reach you, they'll find another provider and you lose months of recurring visits." },
