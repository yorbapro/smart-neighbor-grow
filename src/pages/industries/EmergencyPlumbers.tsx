...
const data: IndustryPageData = {
  ...
  faqs: [
    ...
    { question: "How much do plumbers lose from missed calls?", answer: "$120,000 or more per year. Emergency plumbing calls happen around the clock, and callers who reach voicemail will simply call the next plumber on Google." },
