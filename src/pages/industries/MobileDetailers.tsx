...
const data: IndustryPageData = {
  ...
  faqs: [
    ...
    { question: "How much do mobile detailers lose from missed calls?", answer: "$75,000 or more per year. Detailers are often on-site working when calls come in — every missed call is a booking that goes to a competitor." },
