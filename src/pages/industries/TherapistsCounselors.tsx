...
const data: IndustryPageData = {
  ...
  dayInTheLife: `9:00 AM \u2014 A new client calls, referred by their primary care physician for anxiety management. The BrightLaunchIQ AI Receptionist answers instantly with a compassionate, professional tone. It guides the caller through a quick intake, gathers details about their concerns, explains your therapeutic approaches, and checks their insurance eligibility. It then books the initial consultation directly into your practice management system.\n\n1:00 PM \u2014 While your therapists are working with clients, the AI handles multiple routine calls: one client confirming their upcoming session (handled automatically), another asking about group therapy options (answered by the AI), and a third inquiring about their progress and next steps.\n\n5:00 PM \u2014 After hours, a prospective client calls about a sudden onset of panic attacks. The AI provides immediate advice on coping strategies, logs an urgent message for the on-call therapist, and offers to schedule an emergency consultation for the next morning. It also sends an SMS with relevant practice information and a link to your online intake forms.`,
  faqs: [
    { question: "Can an AI receptionist schedule therapy consultations?", answer: "Yes. The AI captures client concerns, treatment goals, and insurance information, then books initial consultations directly into your SimplePractice calendar." },
    { question: "Does the AI integrate with therapy practice management software?", answer: "Yes. BrightLaunchIQ connects with leading systems like SimplePractice and TherapyNotes to manage appointments, client records, and communication." },
    ...
    { question: "How quickly can a therapy practice get started?", answer: "Most therapy practices are live within 48 hours. We configure your consultation intake, integrate with your systems, and customize for your therapeutic offerings." },
    { question: "What does an AI receptionist cost for therapists and counselors?", answer: "BrightLaunchIQ AI Receptionist starts at $497/month for the Core plan, which includes 24/7 call answering, lead qualification, and CRM integration. That\u2019s a fraction of the cost of a full-time receptionist." },
  ],
};

const TherapistsCounselors = () => <IndustryPageTemplate data={data} />;
