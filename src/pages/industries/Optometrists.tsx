...
const data: IndustryPageData = {
  ...
  faqs: [
    ...
    { question: "How much do optometrists lose from missed calls?", answer: "$65,000 or more per year. Patients needing new glasses or contacts will simply book online with a competitor if they can't reach your office." },
