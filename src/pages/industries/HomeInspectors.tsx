...
const data: IndustryPageData = {
  ...
  faqs: [
    ...
    { question: "How much do home inspectors lose from missed calls?", answer: "$85,000 or more per year. Realtors need inspections booked within tight contract timelines — if you don't answer, they call the next inspector on their list." },
