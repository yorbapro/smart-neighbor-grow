...
const data: IndustryPageData = {
  ...
  faqs: [
    ...
    { question: "Does the AI integrate with AppFolio?", answer: "Yes. BrightLaunchIQ connects with AppFolio to log maintenance tickets, update tenant records, and manage vacancy inquiries seamlessly." },
