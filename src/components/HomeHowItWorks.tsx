...
const HomeHowItWorks = () => {
  return (
    <section id="how-it-works" className="py-16 md:py-24" style={{ background: 'linear-gradient(180deg, hsl(215, 28%, 7%) 0%, hsl(215, 28%, 10%) 50%, hsl(215, 28%, 7%) 100%)' }}>
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            How BrightLaunchIQ
            <br />
            <span className="text-primary">AI Receptionist Works</span>
          </h2>
        </div>
