...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    industries: [
      { label: "HVAC Contractors", href: "/ai-receptionist/industries/hvac-contractors" },
      { label: "Emergency Plumbing", href: "/ai-receptionist/industries/emergency-plumbers" },
      { label: "Personal Injury Law", href: "/ai-receptionist/industries/personal-injury-lawyers" },
      { label: "Medical Practices", href: "/ai-receptionist/industries/dental-clinics" },
      { label: "Real Estate", href: "/ai-receptionist/industries/residential-real-estate" },
