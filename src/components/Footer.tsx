...
const Footer = () => {
  ...
  const footerLinks = {
    solutions: [
      ...
      { label: "Free AI Audit", href: "/locallift/resources/aeo-audit" },
    ],
    industries: [
      { label: "AI Receptionist for HVAC Contractors", href: "/ai-receptionist/industries/hvac-contractors" },
      { label: "AI Receptionist for Emergency Plumbing", href: "/ai-receptionist/industries/emergency-plumbers" },
      { label: "AI Receptionist for Personal Injury Law", href: "/ai-receptionist/industries/personal-injury-lawyers" },
      { label: "AI Receptionist for Medical Practices", href: "/ai-receptionist/industries/dental-clinics" },
      { label: "AI Receptionist for Real Estate", href: "/ai-receptionist/industries/residential-real-estate" },
      { label: "View All Industries →", href: "/ai-receptionist/industries" },
    ],
    resources: [
      { label: "AI Receptionists 101 Guide", href: "/ai-receptionist/resources/ai-receptionists-101" },
      { label: "Comprehensive AI Receptionist Guide", href: "/ai-receptionist/resources/ai-receptionist-guide" },
      { label: "AI Receptionist Learning Center", href: "/ai-receptionist/learning-center" },
