...
const coreIncluded: IncludedSection[] = [
  ...
  { icon: Lock, title: "Security & Compliance", description: "Enterprise-grade encryption and compliance.", items: ["AES-256 encrypted data storage", "Secure API connections", "Role-based access controls", "Call recording compliance messaging", "Audit logging", "Data retention controls"] },
