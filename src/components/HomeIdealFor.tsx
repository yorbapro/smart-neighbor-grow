import { Wrench, Stethoscope, Scale, Briefcase, Building2, MapPin, ArrowRight } from "lucide-react";
      ...
      <div className="container">
        ...
        <div className="text-center">
          <Button variant="hero" size="lg" asChild className="group">
            <Link to="/ai-receptionist/industries" aria-label="Explore AI Receptionist Industry Solutions">
              Explore AI Receptionist Industry Solutions
